package com.game.consumer.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Message> consumerFactory(ObjectMapper objectMapper) {
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(Message.class, objectMapper));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Message> kafkaListenerContainerFactory(
            ConsumerFactory<String, Message> cf) {
